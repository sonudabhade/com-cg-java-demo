...
//4. access non static member in non static context - restricted access - this keyword reference  
...
//		System.out.println(balance);
  ...
  //      c1.checkBalance();//Non Static method access
       
 //       openAccount(); // static method variable directly access
       
       // System.out.println(ifsc); //static Variable access directly
        //System.out.println(c1.balance);  // non static can be access only using object reference
